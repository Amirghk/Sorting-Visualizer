    ...
    for (let i = 0; i < animations.length; i++) { 
      ...
      if (i % 3 === 0) {
        ...
        if (typeof barThreeIdx !== 'undefined') {
            ...
            (barThreeIdx > LENGTH) ? barThreeIdx = LENGTH : arrayBars[barThreeIdx].style.backgroundColor = 'blue';
        }
      }
      ...
      arrayBars[barOneIdx].style.backgroundColor = 'powderblue';
      arrayBars[barTwoIdx].style.backgroundColor = 'powderblue';
      
      if (typeof barThreeIdx !== 'undefined') {
      arrayBars[barThreeIdx].style.backgroundColor = 'powderblue';
      }
    }
  }
